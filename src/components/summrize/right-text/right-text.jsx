    ...
    return(
        <div className="box-text-container">
            ...
            <div className="typed-text-box pt-5 pb-3">
                {status != "succeeded" && status != "fetching" ?<p className="typed-text">Your summrized text...</p> 
                :
                <>
                ...
                <div className="d-flex justify-content-center align-items-center">
                 ...
                 : 
                 <p className="typed-text" id="ready-to-copy" > {text?.summary}</p>
            ...
            <div className="button-section">
                ...
                <img src={process.env.PUBLIC_URL+'/img/refresh.png'} alt=''/>
                    ...
                    {text?.summary ? 
                        <CopyToClipboard text={text?.summary}
